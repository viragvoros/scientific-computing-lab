...
table_stable_cases = table( ...
    stability_explicit_euler, stability_heun, stability_implicit_euler, stability_adams_moulton, stability_adams_moulton_lin1, stability_adams_moulton_lin2, ...
    'VariableNames',{'explicit Euler', 'Heun',  'implicit Euler', 'AdamsMoulton', 'Adams-Moulton l1', 'Adams-Moulton l2'}, ...
    'RowNames',{'δt = 0.5', 'δt = 0.25', 'δt = 0.125', 'δt = 0.0625', 'δt = 0.03125'} ...
) 
